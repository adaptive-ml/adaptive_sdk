...
class AbcampaignCreate(BaseModel):
    ...
    feedback_type: FeedbackType = Field(
        alias="feedbackType", default=FeedbackType.DIRECT
    )
...
class AddExternalModelInput(BaseModel):
    ...
    provider_data: Optional["ModelProviderDataInput"] = Field(
        alias="providerData", default=None
    )
...
class GuidelinesTrainingParamsInput(BaseModel):
    ...
    judge_model_prompt: List["GuidelineInput"] = Field(alias="judgeModelPrompt")
...
class MetricCreate(BaseModel):
    ...
    key: Optional[str] = None
    kind: MetricKind
    scoring_type: MetricScoringType = Field(
        alias="scoringType", default=MetricScoringType.HIGHER_IS_BETTER
    )
    description: Optional[str] = None
...
class MetricTrainingParamsInput(BaseModel):
    ...
    metric_metadata: Optional["MetricTrainingParamsMetadata"] = Field(
        alias="metricMetadata", default=None
    )
...
class MetricTrainingParamsMetadata(BaseModel):
    ...
    scalar_metric: Optional["ScalarMetricConfigInput"] = Field(
        alias="scalarMetric", default=None
    )
...
class SampleConfigInput(BaseModel):
    ...
    feedback_type: Optional[FeedbackTypeInput] = Field(
        alias="feedbackType", default=None
    )
...
class TrainingMetadataInput(BaseModel):
    ...
    alignment_method: TrainingMetadataInputAlignmentMethod = Field(
...
class UpdateCompletion(BaseModel):
    ...
    id: Any
    remove_labels: Optional[List["CompletionLabelValue"]] = Field(
        alias="removeLabels", default=None
    )
    add_labels: Optional[List["CompletionLabelValue"]] = Field(
        alias="addLabels", default=None
    )
...
class UpdateModelService(BaseModel):
    ...
    name: Optional[str] = None
    system_prompt_template: Optional[Any] = Field(
...
GuidelinesTrainingParamsInput.model_rebuild()
