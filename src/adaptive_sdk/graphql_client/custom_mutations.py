...
class Mutation:
    ...
    def create_ab_campaign(cls, input: AbcampaignCreate) -> AbcampaignFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "AbcampaignCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return AbcampaignFields(
            field_name="createAbCampaign", arguments=cleared_arguments
        )

    @classmethod
    def cancel_ab_campaign(cls, input: str) -> GraphQLField:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "IdOrKey!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def create_evaluation_job(cls, input: EvaluationCreate) -> EvaluationJobFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "EvaluationCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return EvaluationJobFields(
            field_name="createEvaluationJob", arguments=cleared_arguments
        )
    ...
    def cancel_evaluation_job(cls, id: Any) -> GraphQLField:
        ...
        return GraphQLField(
            field_name="cancelEvaluationJob", arguments=cleared_arguments
        )

    @classmethod
    def update_completion(cls, input: UpdateCompletion) -> CompletionFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "UpdateCompletion!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return CompletionFields(
            field_name="updateCompletion", arguments=cleared_arguments
        )

    @classmethod
    def create_system_prompt_template(
        cls, input: SystemPromptTemplateCreate
    ) -> SystemPromptTemplateFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "SystemPromptTemplateCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return SystemPromptTemplateFields(
            field_name="createSystemPromptTemplate", arguments=cleared_arguments
        )

    @classmethod
    def derive_system_prompt_template(
        cls, input: SystemPromptTemplateUpdate
    ) -> SystemPromptTemplateFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "SystemPromptTemplateUpdate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return SystemPromptTemplateFields(
            field_name="deriveSystemPromptTemplate", arguments=cleared_arguments
        )

    @classmethod
    def create_metric(cls, input: MetricCreate) -> MetricFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "MetricCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def link_metric(cls, input: MetricLink) -> MetricWithContextFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "MetricLink!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return MetricWithContextFields(
            field_name="linkMetric", arguments=cleared_arguments
        )

    @classmethod
    def unlink_metric(cls, input: MetricUnlink) -> GraphQLField:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "MetricUnlink!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def attach_model(cls, input: AttachModel) -> ModelServiceFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "AttachModel!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def disconnect_model(cls, input: ModelServiceDisconnect) -> GraphQLField:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "ModelServiceDisconnect!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def update_model_service(cls, input: UpdateModelService) -> ModelServiceFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "UpdateModelService!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return ModelServiceFields(
            field_name="updateModelService", arguments=cleared_arguments
        )
    ...
    def deploy_model(
        ...
        *,
        ...
        arguments: Dict[str, Dict[str, Any]] = {
            ...
            "wait": {"type": "Boolean!", "value": wait},
            "placement": {"type": "ModelPlacementInput", "value": placement},
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def add_external_model(cls, input: AddExternalModelInput) -> ModelFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "AddExternalModelInput!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def add_model(cls, input: AddModelInput) -> ModelFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "AddModelInput!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def import_hf_model(cls, input: AddHFModelInput) -> GraphQLField:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "AddHFModelInput!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def create_training_job(cls, input: TrainingJobInput) -> TrainingJobFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "TrainingJobInput!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
        return TrainingJobFields(
            field_name="createTrainingJob", arguments=cleared_arguments
        )
    ...
    def create_use_case(cls, input: UseCaseCreate) -> UseCaseFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "UseCaseCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def create_api_key(cls, input: ApiKeyCreate) -> ApiKeyFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "ApiKeyCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def set_team_member(cls, input: TeamMemberSet) -> TeamMemberFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "TeamMemberSet!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def remove_team_member(cls, input: TeamMemberRemove) -> UserFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "TeamMemberRemove!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def create_role(cls, input: RoleCreate) -> RoleFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "RoleCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    def create_team(cls, input: TeamCreate) -> TeamFields:
        arguments: Dict[str, Dict[str, Any]] = {
            "input": {"type": "TeamCreate!", "value": input}
        }
        cleared_arguments = {
            key: value for key, value in arguments.items() if value["value"] is not None
        }
    ...
    @classmethod
    def update_feedback(
        cls, id: Any, input: FeedbackUpdateInput
    ) -> DirectFeedbackFields:
        arguments: Dict[str, Dict[str, Any]] = {
        ...
        return DirectFeedbackFields(
            field_name="updateFeedback", arguments=cleared_arguments
        )

    @classmethod
    def add_direct_feedback(
        cls, completion_id: Any, metric_id: str, input: FeedbackAddInput
    ) -> DirectFeedbackFields:
        arguments: Dict[str, Dict[str, Any]] = {
        ...
        return DirectFeedbackFields(
            field_name="addDirectFeedback", arguments=cleared_arguments
        )
