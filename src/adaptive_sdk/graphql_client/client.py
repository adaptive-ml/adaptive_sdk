...
class GQLClient(BaseClientOpenTelemetry):
    ...
    def create_metric(self, input: MetricCreate, **kwargs: Any) ->CreateMetric:
        ...
        response = self.execute(query=query, operation_name='CreateMetric',
    ...
    def link_metric(self, input: MetricLink, **kwargs: Any) ->LinkMetric:
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='LinkMetric',
            variables=variables, **kwargs)
        data = self.get_data(response)
    ...
    def unlink_metric(self, input: MetricUnlink, **kwargs: Any) ->UnlinkMetric:
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='UnlinkMetric',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return UnlinkMetric.model_validate(data)

    def attach_model_to_use_case(self, input: AttachModel, **kwargs: Any
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name=
            'AttachModelToUseCase', variables=variables, **kwargs)
        data = self.get_data(response)
        return AttachModelToUseCase.model_validate(data)

    def add_external_model(self, input: AddExternalModelInput, **kwargs: Any
        ) ->AddExternalModel:
        query = gql(
            """
    ...
    def add_model(self, input: AddModelInput, **kwargs: Any) ->AddModel:
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='AddModel',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return AddModel.model_validate(data)

    def update_model(self, input: UpdateModelService, **kwargs: Any
        ) ->UpdateModel:
        query = gql(
            """
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='UpdateModel',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return UpdateModel.model_validate(data)

    def deploy_model(self, id_or_key: str, wait: bool, **kwargs: Any
        ) ->DeployModel:
        query = gql(
            """
        ...
        response = self.execute(query=query, operation_name='DeployModel',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return DeployModel.model_validate(data)

    def terminate_model(self, id_or_key: str, force: bool, **kwargs: Any
        ) ->TerminateModel:
        query = gql(
            """
    ...
    def create_use_case(self, input: UseCaseCreate, **kwargs: Any
        ) ->CreateUseCase:
        query = gql(
            """
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='CreateUseCase',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return CreateUseCase.model_validate(data)

    def create_ab_campaign(self, input: AbcampaignCreate, **kwargs: Any
        ) ->CreateAbCampaign:
        query = gql(
            """
    ...
    def load_dataset(self, input: DatasetCreate, file: Upload, **kwargs: Any
        ) ->LoadDataset:
        query = gql(
            """
        ...
        response = self.execute(query=query, operation_name='LoadDataset',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return LoadDataset.model_validate(data)

    def create_training_job(self, input: TrainingJobInput, **kwargs: Any
        ) ->CreateTrainingJob:
        query = gql(
            """
    ...
    def create_evaluation_job(self, input: EvaluationCreate, **kwargs: Any
        ) ->CreateEvaluationJob:
        query = gql(
            """
    ...
    def cancel_evaluation_job(self, id: Any, **kwargs: Any
        ) ->CancelEvaluationJob:
        query = gql(
            """
    ...
    def add_hf_model(self, input: AddHFModelInput, **kwargs: Any) ->AddHFModel:
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='AddHFModel',
            variables=variables, **kwargs)
        data = self.get_data(response)
    ...
    def update_user(self, input: TeamMemberSet, **kwargs: Any) ->UpdateUser:
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='UpdateUser',
            variables=variables, **kwargs)
        data = self.get_data(response)
    ...
    def list_datasets(self, input: str, **kwargs: Any) ->ListDatasets:
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='ListDatasets',
            variables=variables, **kwargs)
        data = self.get_data(response)
    ...
    def list_use_cases(self, **kwargs: Any) ->ListUseCases:
        ...
        response = self.execute(query=query, operation_name='ListUseCases',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return ListUseCases.model_validate(data)

    def list_models(self, **kwargs: Any) ->ListModels:
        query = gql(
            """
            query ListModels {
              models {
        ...
        variables: Dict[str, object] = {}
        response = self.execute(query=query, operation_name='ListModels',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return ListModels.model_validate(data)

    def describe_model_admin(self, input: str, **kwargs: Any
        ) ->DescribeModelAdmin:
        query = gql(
            """
    ...
    def describe_model(self, input: str, **kwargs: Any) ->DescribeModel:
        ...
        variables: Dict[str, object] = {'input': input}
        response = self.execute(query=query, operation_name='DescribeModel',
            variables=variables, **kwargs)
        data = self.get_data(response)
    ...
    def list_metrics(self, **kwargs: Any) ->ListMetrics:
        ...
        variables: Dict[str, object] = {}
        response = self.execute(query=query, operation_name='ListMetrics',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return ListMetrics.model_validate(data)

    def describe_metric_admin(self, input: str, **kwargs: Any
        ) ->DescribeMetricAdmin:
        query = gql(
            """
    ...
    def list_ab_campaigns(self, input: AbCampaignFilter, **kwargs: Any
        ) ->ListAbCampaigns:
        query = gql(
            """
    ...
    def describe_ab_campaign(self, input: str, **kwargs: Any
        ) ->DescribeAbCampaign:
        query = gql(
            """
    ...
    def describe_me(self, **kwargs: Any) ->DescribeMe:
        query = gql(
            """
            query DescribeMe {
              me {
        ...
        variables: Dict[str, object] = {}
        response = self.execute(query=query, operation_name='DescribeMe',
            variables=variables, **kwargs)
        data = self.get_data(response)
        return DescribeMe.model_validate(data)

    def list_interactions(self, filter: ListCompletionsFilterInput, page:
        CursorPageInput, order: Union[Optional[List[OrderPair]], UnsetType]
        =UNSET, **kwargs: Any) ->ListInteractions:
        query = gql(
            """
    ...
    def list_grouped_interactions(self, filter: ListCompletionsFilterInput,
        group_by: CompletionGroupBy, page: CursorPageInput, order: Union[
        Optional[List[OrderPair]], UnsetType]=UNSET, **kwargs: Any
    ...
    def describe_interaction(self, use_case: str, id: Any, **kwargs: Any
        ) ->DescribeInteraction:
        query = gql(
            """
    ...
    def describe_training_job(self, id: Any, **kwargs: Any
        ) ->DescribeTrainingJob:
        query = gql(
            """
    ...
    def describe_evaluation_job(self, id: Any, **kwargs: Any
    ...
    def list_users(self, **kwargs: Any) ->ListUsers:
        ...
        variables: Dict[str, object] = {}
        response = self.execute(query=query, operation_name='ListUsers',
            variables=variables, **kwargs)
        data = self.get_data(response)
    ...
    def me(self, **kwargs: Any) ->Me:
        ...
        variables: Dict[str, object] = {}
        response = self.execute(query=query, operation_name='Me', variables
            =variables, **kwargs)
        data = self.get_data(response)
    ...
    def list_teams(self, **kwargs: Any) ->ListTeams:
        ...
        variables: Dict[str, object] = {}
        response = self.execute(query=query, operation_name='ListTeams',
            variables=variables, **kwargs)
        data = self.get_data(response)
