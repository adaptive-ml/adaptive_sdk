...
class CompletionData(BaseModel):
    ...
    id: Any
    prompt: str
    chat_messages: Optional[List["CompletionDataChatMessages"]] = Field(
        alias="chatMessages"
    )
    completion: Optional[str]
    source: CompletionSource
    model: Optional["CompletionDataModel"]
    direct_feedbacks: List["CompletionDataDirectFeedbacks"] = Field(
        alias="directFeedbacks"
    )
    comparison_feedbacks: List["CompletionDataComparisonFeedbacks"] = Field(
        alias="comparisonFeedbacks"
    )
...
class CompletionDataComparisonFeedbacksPreferedCompletion(
...
class CompletionDataComparisonFeedbacksOtherCompletion(
    CompletionComparisonFeedbackData
):
    """@public"""
...
class EvaluationJobData(BaseModel):
    ...
    model_services: List["EvaluationJobDataModelServices"] = Field(
        alias="modelServices"
    )
...
class TrainingConfigOutputData(BaseModel):
    ...
    training_metadata: "TrainingConfigOutputDataTrainingMetadata" = Field(
        alias="trainingMetadata"
    )
...
class TrainingConfigOutputDataTrainingMetadata(BaseModel):
    ...
    alignment_method: TrainingMetadataOutputAlignmentMethod = Field(
...
class TrainingConfigOutputDataTrainingObjectiveGuidelinesTrainingParamsOutput(
    ...
    judge_model_prompt: List[
        "TrainingConfigOutputDataTrainingObjectiveGuidelinesTrainingParamsOutputJudgeModelPrompt"
    ] = Field(alias="judgeModelPrompt")


class TrainingConfigOutputDataTrainingObjectiveGuidelinesTrainingParamsOutputJudgeModelPrompt(
    BaseModel
):
    """@public"""
...
class TrainingJobDataConfig(BaseModel):
    ...
    sample_config: "TrainingJobDataConfigSampleConfig" = Field(alias="sampleConfig")
    training_config: "TrainingJobDataConfigTrainingConfig" = Field(
        alias="trainingConfig"
    )
...
class TrainingJobDataConfigSampleConfigDatasourceSampleDatasourceCompletionsOutput(
    BaseModel
):
    """@public"""
...
class TrainingJobDataConfigSampleConfigDatasourceSampleDatasourceCompletionsOutputFilter(
...
class TrainingJobDataConfigSampleConfigDatasourceSampleDatasourceDatasetOutput(
    BaseModel
):
    """@public"""
